...
const port = 3011
const webserver = `http://host.docker.internal:4200`
// const webserver = `http://localhost:4200`
const ua_regex = '/APIs-Google|Mediapartners-Google|AdsBot|Googlebot|FeedFetcher-Google|Google-Read-Aloud|DuplexWeb-Google|Google Favicon|Bingbot|AdIdxBot|BingPreview|Baiduspider|YandexBot|facebookexternalhit|Twitterbot/i'
